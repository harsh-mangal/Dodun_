      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="bg-white overflow-hidden">
            <button
              className="w-full text-left px-6 py-4 flex justify-between items-center text-lg font-medium bg-white transition border-b border-black"
            ...
            <div
              className={`px-6 text-gray-600 text-md text-left transition-all duration-300 ${
                openIndex === index
                  ? "max-h-[1000px] py-4"
