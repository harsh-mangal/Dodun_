  ...
  return (
    <>
      ...
      <div className="manrope max-w-5xl mx-auto p-4 sm:p-8">
        {/* Title */}
        <h1 className="text-5xl  font-semibold text-gray-900 text-justify sm:text-left">
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-8 text-justify">
        ...
        <ol className="list-disc list-inside space-y-2 text-lg mt-5 mx-7">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-7">
        ...
        <ol className="list-disc list-inside space-y-1 text-lg mt-5 mx-7">
      ...
      {/* Button */}
      <div className="flex justify-end border-b boder-black">
        <div></div>
        <div className="w-80 p-4 mx-60">
          <a
            href="/second"
            className="flex items-center gap-3 bg-blue-200 hover:scale-105 transition p-3 rounded-lg shadow-md"
          >
