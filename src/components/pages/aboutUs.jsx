  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto p-8 mt-5">
        ...
        <p data-aos="zoom-in" className="mt-4 text-gray-700 text-center">
          ...
          helping businesses thrive. When you partner with DODUN Soft Solutions,
          you choose a team that genuinely cares about your success. We take the
          time to understand your unique challenges and objectives, crafting
          tailored solutions that align with your vision. Our holistic approach,
          combined with our commitment to quality and client satisfaction, sets
          us apart in the industry. Here’s what you can expect from us:
        </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p class="text-gray-700 text-left">
                  ...
                  insights and support to help you navigate the digital
                  landscape.
                </p>
              </div>
        ...
        <div className="mt-20">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div
              data-aos="fade-right"
              className="text-center p-6 bg-slate-300 rounded-lg"
            >
